5.times do
  court_case = CourtCase.create(title: Faker::Lorem.sentence(word_count: 3), description: Faker::Lorem.sentence(word_count: 30), value: Faker::Number.decimal(l_digits: 2),
